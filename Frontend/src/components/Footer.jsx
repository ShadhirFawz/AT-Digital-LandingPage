...
const Footer = () => {
  return (
    <footer className="bg-[hsl(231_48%_48%)] text-[#ffffff] py-12">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between gap-12">
        ...
        <div className="md:w-[55%] lg:w-[50%] flex flex-col md:flex-row gap-12 prs-8 md:pr-12 lg:pl-16">
          <div className="md:w-1/2">
            <h3 className="font-bold text-lg mb-4">Our Technologies</h3>
            <ul className="text-sm space-y-3">
              <li className="hover:text-[hsl(28_80%_58%)] transition-colors">ReactJS</li>
              <li className="hover:text-[hsl(28_80%_58%)] transition-colors">Gatsby</li>
              <li className="hover:text-[hsl(28_80%_58%)] transition-colors">NextJS</li>
              <li className="hover:text-[hsl(28_80%_58%)] transition-colors">NodeJS</li>
            </ul>
          </div>
          <div className="md:w-1/2">
            <h3 className="font-bold text-lg mb-4">Our Services</h3>
            <ul className="text-sm space-y-3">
              <li className="hover:text-[hsl(28_80%_58%)] transition-colors">Social Media Marketing</li>
              <li className="hover:text-[hsl(28_80%_58%)] transition-colors">Web & Mobile App Development</li>
              <li className="hover:text-[hsl(28_80%_58%)] transition-colors">Data & Analytics</li>
            </ul>
          </div>
        </div>
      </div>
